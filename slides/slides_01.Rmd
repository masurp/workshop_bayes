...
hdis <- hdi(posteriors$b_perceptions_std, ci = c(.75, .90, .95, .99))
hdis
...
plotPriorPost(m_bay2, b_perceptions_std)
```
...
tibble(x = seq(-1, 1, by = .001),
       ...
       "mildy informative" = dnorm(x = x, mean = 0.2, sd = .5)) %>%
  gather(key, value, -x) %>%
...
p1 <- plotPriorPost(step1, b_norm_n) + theme(legend.position = "none") + ggtitle("Weakly informative prior 1")
p2 <- plotPriorPost(step2, b_norm_n) + theme(legend.position = "none") + ggtitle("Posterior 1 = Prior 2")
p3 <- plotPriorPost(step3, b_norm_n) + theme(legend.position = "none") + ggtitle("Posterior 2 = Prior 3")
p4 <- plotPriorPost(step4, b_norm_n) + theme(legend.position = "none") + ggtitle("Posterior 3 = Prior 4")
