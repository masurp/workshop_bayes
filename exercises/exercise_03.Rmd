...
Likewise, we can use the summary function to produce a first informative overview of the results. 
...
The median effect size of the relationship between perceptions and behaviors is b = .55 (95% HDI[.49, .62]). Did anyone use differnet priors? What are your results?
...
Based on these plots, we are not concerned that the chains did not converge. This is how they should look like. 
